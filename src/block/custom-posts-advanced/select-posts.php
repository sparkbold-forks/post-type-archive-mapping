 ...
 */
function ptam_custom_posts_advanced( $attributes ) {
	$paged = 0;
 ...
 */
function ptam_register_custom_posts_advanced_block() {
	...
	register_block_type(
		...
		array(
			...
			'render_callback' => 'ptam_custom_posts_advanced',
			'editor_script'   => 'ptam-custom-posts-gutenberg',
		)
	);
}

add_action( 'init', 'ptam_register_custom_posts_advanced_block' );
